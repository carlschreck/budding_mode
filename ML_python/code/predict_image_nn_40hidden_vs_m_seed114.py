...
dump(clf, '../params/fit_params_nn_image_L40_seed114_alpa1e0_m3600.joblib')
...
print(sum(p_test==y_test)/len(y_test))
print()
dump(clf, '../params/fit_params_nn_image_L40_seed114_alpa1e0_m2400.joblib')
perfmat=np.zeros((3,3))
for i in range(0,len(p_test)):
    if(y_test[i]==1 and p_test[i]==1):
        perfmat[0,0]+=1
...
print(sum(p_test==y_test)/len(y_test))
print()
dump(clf, '../params/fit_params_nn_image_L40_seed114_alpa1e0_m1800.joblib')
perfmat=np.zeros((3,3))
for i in range(0,len(p_test)):
    if(y_test[i]==1 and p_test[i]==1):
        perfmat[0,0]+=1
...
print(sum(p_test==y_test)/len(y_test))
print()
dump(clf, '../params/fit_params_nn_image_L40_seed114_alpa1e0_m1200.joblib')
perfmat=np.zeros((3,3))
for i in range(0,len(p_test)):
    if(y_test[i]==1 and p_test[i]==1):
        perfmat[0,0]+=1
...
print(sum(p_test==y_test)/len(y_test))
print()
dump(clf, '../params/fit_params_nn_image_L40_seed114_alpa1e0_m800.joblib')
perfmat=np.zeros((3,3))
for i in range(0,len(p_test)):
    if(y_test[i]==1 and p_test[i]==1):
        perfmat[0,0]+=1
...
print(sum(p_test==y_test)/len(y_test))
print()
dump(clf, '../params/fit_params_nn_image_L40_seed114_alpa1e0_m600.joblib')
perfmat=np.zeros((3,3))
for i in range(0,len(p_test)):
    if(y_test[i]==1 and p_test[i]==1):
        perfmat[0,0]+=1
...
print(sum(p_test==y_test)/len(y_test))
print()
dump(clf, '../params/fit_params_nn_image_L40_seed114_alpa1e0_m400.joblib')
perfmat=np.zeros((3,3))
for i in range(0,len(p_test)):
    if(y_test[i]==1 and p_test[i]==1):
        perfmat[0,0]+=1
...
print(sum(p_test==y_test)/len(y_test))
print()
dump(clf, '../params/fit_params_nn_image_L40_seed114_alpa1e0_m200.joblib')
perfmat=np.zeros((3,3))
for i in range(0,len(p_test)):
    if(y_test[i]==1 and p_test[i]==1):
        perfmat[0,0]+=1
...
print(sum(p_test==y_test)/len(y_test))
print()
dump(clf, '../params/fit_params_nn_image_L40_seed114_alpa1e0_m100.joblib')
perfmat=np.zeros((3,3))
for i in range(0,len(p_test)):
    if(y_test[i]==1 and p_test[i]==1):
        perfmat[0,0]+=1
...
print(sum(p_test==y_test)/len(y_test))
print()
dump(clf, '../params/fit_params_nn_image_L40_seed114_alpa1e0_m50.joblib')
perfmat=np.zeros((3,3))
for i in range(0,len(p_test)):
    if(y_test[i]==1 and p_test[i]==1):
        perfmat[0,0]+=1
...
print(sum(p_test==y_test)/len(y_test))
print()
dump(clf, '../params/fit_params_nn_image_L40_seed114_alpa1e0_m20.joblib')
perfmat=np.zeros((3,3))
for i in range(0,len(p_test)):
    if(y_test[i]==1 and p_test[i]==1):
        perfmat[0,0]+=1
