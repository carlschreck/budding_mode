...
y_train=y_train[0:m];
X_train=X_train[0:m,:];        
clf=MLPClassifier(solver='lbfgs',alpha=1.0,max_iter=200,hidden_layer_sizes=2,random_state=1);
...
print()
dump(clf, 'fit_params_nn_image_L2_seed1_alpa1e0.joblib')
...
y_train=y_train[0:m];
X_train=X_train[0:m,:];        
clf=MLPClassifier(solver='lbfgs',alpha=0.0,max_iter=200,hidden_layer_sizes=2,random_state=1);
clf.fit(X_train,y_train)
p_train=clf.predict(X_train);
p_cross=clf.predict(X_cross);
p_test=clf.predict(X_test);
...
print(sum(p_test==y_test)/len(y_test))
print()
dump(clf, 'fit_params_nn_image_L2_seed1_alpa0.joblib')
perfmat=np.zeros((3,3))
for i in range(0,len(p_test)):
    if(y_test[i]==1 and p_test[i]==1):
        perfmat[0,0]+=1
...
y_train=y_train[0:m];
X_train=X_train[0:m,:];        
clf=MLPClassifier(solver='lbfgs',alpha=0.0001,max_iter=200,hidden_layer_sizes=2,random_state=1);
clf.fit(X_train,y_train)
p_train=clf.predict(X_train);
p_cross=clf.predict(X_cross);
p_test=clf.predict(X_test);
...
print(sum(p_test==y_test)/len(y_test))
print()
dump(clf, 'fit_params_nn_image_L2_seed1_alpa1e-4.joblib')
perfmat=np.zeros((3,3))
for i in range(0,len(p_test)):
    if(y_test[i]==1 and p_test[i]==1):
        perfmat[0,0]+=1
...
y_train=y_train[0:m];
X_train=X_train[0:m,:];        
clf=MLPClassifier(solver='lbfgs',alpha=0.001,max_iter=200,hidden_layer_sizes=2,random_state=1);
clf.fit(X_train,y_train)
p_train=clf.predict(X_train);
p_cross=clf.predict(X_cross);
p_test=clf.predict(X_test);
...
print(sum(p_test==y_test)/len(y_test))
print()
dump(clf, 'fit_params_nn_image_L2_seed1_alpa1e-3.joblib')
perfmat=np.zeros((3,3))
for i in range(0,len(p_test)):
    if(y_test[i]==1 and p_test[i]==1):
        perfmat[0,0]+=1
...
y_train=y_train[0:m];
X_train=X_train[0:m,:];        
clf=MLPClassifier(solver='lbfgs',alpha=0.01,max_iter=200,hidden_layer_sizes=2,random_state=30);
clf.fit(X_train,y_train)
p_train=clf.predict(X_train);
p_cross=clf.predict(X_cross);
p_test=clf.predict(X_test);
...
print(sum(p_test==y_test)/len(y_test))
print()
dump(clf, 'fit_params_nn_image_L2_seed1_alpa1e-2.joblib')
perfmat=np.zeros((3,3))
for i in range(0,len(p_test)):
    if(y_test[i]==1 and p_test[i]==1):
        perfmat[0,0]+=1
...
y_train=y_train[0:m];
X_train=X_train[0:m,:];        
clf=MLPClassifier(solver='lbfgs',alpha=0.1,max_iter=200,hidden_layer_sizes=2,random_state=31);
clf.fit(X_train,y_train)
p_train=clf.predict(X_train);
p_cross=clf.predict(X_cross);
p_test=clf.predict(X_test);
...
print(sum(p_test==y_test)/len(y_test))
print()
dump(clf, 'fit_params_nn_image_L2_seed1_alpa1e-1.joblib')
perfmat=np.zeros((3,3))
for i in range(0,len(p_test)):
    if(y_test[i]==1 and p_test[i]==1):
        perfmat[0,0]+=1
