...
y_train=y_train[0:m];
X_train=X_train[0:m,:];        
clf=MLPClassifier(solver='lbfgs',alpha=0.2,max_iter=200,hidden_layer_sizes=40,random_state=3);
...
print()
dump(clf, 'fit_params_nn_image_L40_seed3_alpa2e-1.joblib')
...
y_train=y_train[0:m];
X_train=X_train[0:m,:];        
clf=MLPClassifier(solver='lbfgs',alpha=0.05,max_iter=200,hidden_layer_sizes=40,random_state=3);
clf.fit(X_train,y_train)
p_train=clf.predict(X_train);
p_cross=clf.predict(X_cross);
p_test=clf.predict(X_test);
...
print(sum(p_test==y_test)/len(y_test))
print()
dump(clf, 'fit_params_nn_image_L40_seed3_alpa5e-2.joblib')
perfmat=np.zeros((3,3))
for i in range(0,len(p_test)):
    if(y_test[i]==1 and p_test[i]==1):
        perfmat[0,0]+=1
...
y_train=y_train[0:m];
X_train=X_train[0:m,:];        
clf=MLPClassifier(solver='lbfgs',alpha=0.02,max_iter=200,hidden_layer_sizes=40,random_state=3);
clf.fit(X_train,y_train)
p_train=clf.predict(X_train);
p_cross=clf.predict(X_cross);
p_test=clf.predict(X_test);
...
print(sum(p_test==y_test)/len(y_test))
print()
dump(clf, 'fit_params_nn_image_L40_seed3_alpa2e-2.joblib')
perfmat=np.zeros((3,3))
for i in range(0,len(p_test)):
    if(y_test[i]==1 and p_test[i]==1):
        perfmat[0,0]+=1
...
y_train=y_train[0:m];
X_train=X_train[0:m,:];        
clf=MLPClassifier(solver='lbfgs',alpha=0.5,max_iter=200,hidden_layer_sizes=40,random_state=3);
clf.fit(X_train,y_train)
p_train=clf.predict(X_train);
p_cross=clf.predict(X_cross);
p_test=clf.predict(X_test);
...
print(sum(p_test==y_test)/len(y_test))
print()
dump(clf, 'fit_params_nn_image_L40_seed3_alpa5e-1.joblib')
perfmat=np.zeros((3,3))
for i in range(0,len(p_test)):
    if(y_test[i]==1 and p_test[i]==1):
        perfmat[0,0]+=1
