...
hidden_layer_size=3;      # 2 hidden units
...
y_train=y_train[0:m];
X_train=X_train[0:m,:];        
clf=MLPClassifier(solver='lbfgs',alpha=1.0,max_iter=200,hidden_layer_sizes=hidden_layer_size,random_state=2);
...
dump(clf, '../params/fit_params__nn_image_L3_seed1_alpa1e0_m5040.joblib')
...
print(sum(p_cross==y_cross)/len(y_cross))
print(sum(p_test==y_test)/len(y_test))
dump(clf, '../params/fit_params__nn_image_L3_seed1_alpa1e0_m3600.joblib')
perfmat=np.zeros((3,3))
for i in range(0,len(p_test)):
    if(y_test[i]==1 and p_test[i]==1):
        perfmat[0,0]+=1
...
print(sum(p_test==y_test)/len(y_test))
print()
dump(clf, '../params/fit_params__nn_image_L3_seed1_alpa1e0_m2400.joblib')
perfmat=np.zeros((3,3))
for i in range(0,len(p_test)):
    if(y_test[i]==1 and p_test[i]==1):
        perfmat[0,0]+=1
...
print(sum(p_test==y_test)/len(y_test))
print()
dump(clf, '../params/fit_params__nn_image_L3_seed1_alpa1e0_m1800.joblib')
perfmat=np.zeros((3,3))
for i in range(0,len(p_test)):
    if(y_test[i]==1 and p_test[i]==1):
        perfmat[0,0]+=1
...
print(sum(p_test==y_test)/len(y_test))
print()
dump(clf, '../params/fit_params__nn_image_L3_seed1_alpa1e0_m1200.joblib')
perfmat=np.zeros((3,3))
for i in range(0,len(p_test)):
    if(y_test[i]==1 and p_test[i]==1):
        perfmat[0,0]+=1
...
print(sum(p_test==y_test)/len(y_test))
print()
dump(clf, '../params/fit_params__nn_image_L3_seed1_alpa1e0_m800.joblib')
perfmat=np.zeros((3,3))
for i in range(0,len(p_test)):
    if(y_test[i]==1 and p_test[i]==1):
        perfmat[0,0]+=1
...
print(sum(p_test==y_test)/len(y_test))
print()
dump(clf, '../params/fit_params__nn_image_L3_seed1_alpa1e0_m600.joblib')
perfmat=np.zeros((3,3))
for i in range(0,len(p_test)):
    if(y_test[i]==1 and p_test[i]==1):
        perfmat[0,0]+=1
...
print(sum(p_test==y_test)/len(y_test))
print()
dump(clf, '../params/fit_params__nn_image_L3_seed1_alpa1e0_m400.joblib')
perfmat=np.zeros((3,3))
for i in range(0,len(p_test)):
    if(y_test[i]==1 and p_test[i]==1):
        perfmat[0,0]+=1
...
print(sum(p_test==y_test)/len(y_test))
print()
dump(clf, '../params/fit_params__nn_image_L3_seed1_alpa1e0_m200.joblib')
perfmat=np.zeros((3,3))
for i in range(0,len(p_test)):
    if(y_test[i]==1 and p_test[i]==1):
        perfmat[0,0]+=1
...
print(sum(p_test==y_test)/len(y_test))
print()
dump(clf, '../params/fit_params__nn_image_L3_seed1_alpa1e0_m100.joblib')
perfmat=np.zeros((3,3))
for i in range(0,len(p_test)):
    if(y_test[i]==1 and p_test[i]==1):
        perfmat[0,0]+=1
...
print(sum(p_test==y_test)/len(y_test))
print()
dump(clf, '../params/fit_params_nn_image_L3_seed1_alpa1e0_m50.joblib')
perfmat=np.zeros((3,3))
for i in range(0,len(p_test)):
    if(y_test[i]==1 and p_test[i]==1):
        perfmat[0,0]+=1
...
print(sum(p_test==y_test)/len(y_test))
print()
dump(clf, '../params/fit_params_nn_image_L3_seed1_alpa1e0_m20.joblib')
perfmat=np.zeros((3,3))
for i in range(0,len(p_test)):
    if(y_test[i]==1 and p_test[i]==1):
        perfmat[0,0]+=1
